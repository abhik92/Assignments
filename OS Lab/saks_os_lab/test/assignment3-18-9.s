...
section .text 
 ...
 ;Loading LTR with my default TSS selector in current GDT
	 mov ax,128; first TSS Descriptor in the GDT; IP = 0x0040
	 LTR ax; IP = 0x0044
...
; Storing the offset of code, data and stack descriptors of the GDT in our segment registers
;mov ax, 8
;mov cs, ax
;mov ax, 48
;mov ds, ax
...
; 0x88 represents TSS-2 descriptor, which is 136 in decimal(128 = start of TSS descr)
;jmp 0x88:0xdead
jmp exit1
error:
	jmp chanSad
...
;Null descriptor
 dd 0x0,0x0
;-------------------------------------
;Code descriptor for privilege level 0
 dd 0xa00000ff, 0x4f9a00 ; page 76 pdf

;Code descriptor for privilege level 1
 dd 0xa10000ff, 0x4fba00 ; 

;Code descriptor for privilege level 2
 dd 0xa20000ff, 0x4fda00

;Code descriptor for privilege level 3
 dd 0xa30000ff, 0x4ffa00

;Code descriptor for Exception handling
 dd 0xa40000ff, 0x4f9a00
;-------------------------------------
 
;Data descriptor for Pl0
 dd 0xb00000ff, 0x409200

;Data descriptor for Pl1
 dd 0xb10000ff, 0x40b200

;Data descriptor for Pl2
 dd 0xb20000ff, 0x40d200

;Data descriptor for Pl3
 dd 0xb30000ff, 0x40f200

;Data descriptor for Exception handling
 dd 0xb40000ff, 0x409200

;-------------------------------------
 

;Stack descriptor for Pl0
 dd 0xc00000ff, 0x409200

;Stack descriptor for Pl1
 dd 0xc10000ff, 0x40b200

;Stack descriptor for Pl2
 dd 0xc20000ff, 0x40d200

;Stack descriptor for Pl3
 dd 0xc30000ff, 0x40f200

;Stack descriptor for Exception handling
 dd 0xc40000ff, 0x409200
;-------------------------------------
