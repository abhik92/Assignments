...
l2:
	cmp ebx , 0
	jne l3
	mov dword[eax] , 0x0000c017
	jmp l4
l3:
	mov dword[eax] , 0x0000b017
...
;;;;;;;;; Self Mapping required pages ;;;;;;;;;
mov eax , 0x10
mov ds , eax
mov dword [0x4028] , 0xa017
mov dword [0x402c] , 0xb017
mov dword [0x4030] , 0xc017
mov dword [0x4034] , 0xd017
mov dword [0x4038] , 0xe017
mov dword [0x403c] , 0xf017
;;; Arbitrary page mapped to a000 ;;;
mov dword [0x4008] , 0xa017
mov dword [0x400c] , 0xb016
;;; Interrupt Disabling ;;;;
;pushfd
;cli

;;; Setting CR3 to point to PD ;;;;;
mov eax , 0xe000
mov CR3 , eax
...
mov eax , 0x28
mov gs , eax
mov dword [gs:0] , 0xbabababa
mov dword [gs:4092] , 0x11111111


;================== Part - 2 =====================
jmp 0x30:dword target-code_base
target: 
    mov dword [gs:12], 0xcafebabe
    jmp 0x8:dword ftarget-code_base
ftarget:
...
mov dword [fs:4] , 0x33333333
jmp final

align 0x800
	pop ebx
	mov dword [0x400c] , 0xb017
	mov dword [gs:20] , 0xaaaaaaaa
	iretd
...
;Data Segment Descriptor of type 0, random DPL and Base
 dd 0xe0001000 , 0x409200			;;; 0x18 for PD ;;
;Data Segment Descriptor of type 1, random DPL and Base
 dd 0xf0001000 , 0x409200			;; 0x20 for PT ;;
;;;Data Segment Descriptor both read and write access;;;
 dd 0x10000fff , 0x409200			;; 0x28 for far data access ;;
;Code Segment Descriptor for a page mapped onto a000 
 dd 0x20000fff,0x4f9b00				;; 0x30 for code

;===================== Changed last bit to 1 =============================
;Data Segment for part - 3
 dd 0x30000fff , 0x409200			;; 0x38 for part-3
