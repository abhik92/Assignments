        ...
        do
        {
            ...
            for(l3=0;l3<mul;l3++)
            {
                for(hh=0;hh<n/r;hh++)
                {
                    ...
                    ans.append("\n");
                    ans.append(convert.str());
                    ans.append(" ");
                    
                        for(j=0;j<r;j++)
                        {
                            ostringstream con;   // stream used for the conversion
                            con << ((hh*r + j)*mul + l3+1);      // insert the textual representation of 'Number' in the characters in the stream
                            ans.append(con.str());
                            ans.append(" ");
                        }
