 ...
 */
public class ExtractFunctions<R, A> implements GJVisitor<R, A> {
	//
	...
	public R visit(Procedure n, A argu) {
		R _ret = null;
		R lab = n.f0.accept(this, argu);
		if (!SymbolTable.functions.contains(lab))
			SymbolTable.functions.add((String) lab);
		n.f1.accept(this, argu);
		n.f2.accept(this, argu);
		n.f3.accept(this, argu);
		n.f4.accept(this, argu);
